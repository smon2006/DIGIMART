...
<div className='w-full flex flex-wrap'>
    <div className='w-full md:w-6/12'>
        <div className='w-full p-4 bg-[#334155] rounded-md text-[#E2E8F0]'>
        ...
        <div className='px-0 md:px-5 py-2'>
            {
                ...
                <input value={state.shopName} onChange={inputHandle} className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="text" name='shopName' id='Shop' placeholder='Shop Name' />
            </div>  

            <div className='flex flex-col w-full gap-1 mb-2'>
                <label htmlFor="division">Division Name</label>
                <input value={state.division} onChange={inputHandle} className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="text" name='division' id='division' placeholder='division Name' />
            </div>  

            <div className='flex flex-col w-full gap-1 mb-2'>
                <label htmlFor="district">District Name</label>
                <input value={state.district} onChange={inputHandle} className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="text" name='district' id='district' placeholder='District Name' />
            </div>  

            <div className='flex flex-col w-full gap-1 mb-2'>
                <label htmlFor="sub">Sub District Name</label>
                <input value={state.sub_district} onChange={inputHandle} className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="text" name='sub_district' id='sub' placeholder='Sub District Name' />
            </div>  
    ...
    <div className='w-full md:w-6/12'>
        ...
        <form  onSubmit={handlePasswordChange} >
             <div className='flex flex-col w-full gap-1 mb-2'>
                ...
                <input className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="email" name='email' id='email' value={passwordData.email} onChange={pinputHandle} placeholder='email' />
            </div>  

            <div className='flex flex-col w-full gap-1 mb-2'>
                <label htmlFor="o_password">Old Password</label>
                <input className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="password" name='old_password' id='o_password' 
                value={passwordData.old_password} onChange={pinputHandle} placeholder='Old Password' />
            </div>  
 
            <div className='flex flex-col w-full gap-1 mb-2'>
                <label htmlFor="n_password">New Password</label>
                <input className='px-4 py-2 focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' type="password" name='new_password' id='n_password' 
