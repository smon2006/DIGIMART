        ...
        <div className='px-2 md:px-7 py-5'>
           <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7 mb-5'>
                ...
                <div className='flex justify-between items-center p-5 bg-[#DBEAFE] rounded-md gap-3'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#1D4ED8] flex justify-center items-center text-xl'>
                    <MdCurrencyExchange  className='text-[#fae8e8] shadow-lg' /> 
                    </div> 
                </div>
    ...
    <div className='pt-5 mb-5'>
        <form onSubmit={sendRequest}>
            <div className='flex gap-3 flex-wrap'>
                <input onChange={(e) => setAmount(e.target.value)} value={amount} min='0' type="number" className='px-3 py-2 md:w-[75%] focus:border-blue-200 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' name='amount' />
                ...
                <div className='flex bg-[#475569] uppercase text-xs font-bold min-w-[340px] rounded-md'>
