...
const Shops = () => {
    ...
    return (
        ...
        <div className='py-1 flex flex-col gap-1'>
            {
                categorys.map((c,i) => <div key={i} className='flex justify-start items-center gap-2 py-1.5 hover:text-[#2563EB] transition-colors'>
                    <input className='accent-[#2563EB] w-4 h-4 cursor-pointer' checked={category === c.name ? true : false} onChange={(e)=>queryCategory(e,c.name)} type="checkbox" id={c.name} />
