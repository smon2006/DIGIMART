...
const Payment = () => {
    ...
    <section className=''>
        ...
        <div onClick={() => setPaymentMethod('stripe')} className={`w-[160px] border-r border-slate-100 cursor-pointer py-6 px-8 transition-colors ${paymentMethod === 'stripe' ? 'bg-blue-50 border-b-2 border-b-[#F26627]':'bg-white hover:bg-slate-50'} `} >
        ...
        <div onClick={() => setPaymentMethod('cod')} className={`w-[160px] border-r border-slate-100 cursor-pointer py-6 px-8 transition-colors ${paymentMethod === 'cod' ? 'bg-blue-50 border-b-2 border-b-[#F26627]':'bg-white hover:bg-slate-50'} `} >
            <div className='flex flex-col gap-[3px] justify-center items-center'>
           ...
           }
        {
            paymentMethod === 'cod' && <div className='w-full px-5 py-8'>
                <button className='px-10 py-3 rounded-lg transition-colors hover:bg-[#C24A16] bg-[#F26627] text-white font-semibold text-sm'>Pay Now</button>
            </div>
        }
        ...
        <div className='flex justify-between items-center font-semibold pt-3 border-t border-slate-100'>
            ...
            <span className='text-xl font-bold text-[#F26627]'>₹{price}</span>
        </div>
