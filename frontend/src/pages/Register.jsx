...
const Register = () => {
    ...
    <div className='flex flex-col gap-1 mb-4'>
        ...
        <input onChange={inputHandle} value={state.name} className='w-full px-4 py-3 border border-slate-300 outline-none focus:border-[#F26627] focus:ring-2 focus:ring-[#F26627]/20 rounded-lg transition-all text-sm' type="text" name="name" id="name" placeholder='Name' required />
    </div>
    ...
    <div className='flex flex-col gap-1 mb-5'>
        ...
        <div className='relative'>
            <input onChange={inputHandle} value={state.password}  className='w-full px-4 py-3 pr-11 border border-slate-300 outline-none focus:border-[#F26627] focus:ring-2 focus:ring-[#F26627]/20 rounded-lg transition-all text-sm' type={showPassword ? 'text' : 'password'} name="password" id="password" placeholder='Password' required />
    ...
    <button className='px-8 w-full py-3 bg-[#F26627] hover:bg-[#C24A16] transition-colors font-semibold text-white rounded-lg'>Register</button>
 
        </form>
    </div>

    <div className='text-center text-slate-500 text-sm pt-1'>
        <p>You Have No Account? <Link className='text-[#F26627] font-semibold hover:underline' to='/login'> Login</Link> </p>
    </div> 
