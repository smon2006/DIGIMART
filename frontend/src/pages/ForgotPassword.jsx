...
const ForgotPassword = () => {
    ...
    <div className='flex flex-col gap-1 mb-4'>
        ...
        <input onChange={inputHandle} value={state.new_password} className='w-full px-4 py-3 border border-slate-300 outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/20 rounded-lg transition-all text-sm' type="password" name="new_password" id="new_password" placeholder='New Password' required />
    </div>

    <div className='flex flex-col gap-1 mb-5'>
        <label className='text-sm font-medium text-slate-700' htmlFor="confirm_password">Confirm New Password</label>
        <input onChange={inputHandle} value={state.confirm_password} className='w-full px-4 py-3 border border-slate-300 outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/20 rounded-lg transition-all text-sm' type="password" name="confirm_password" id="confirm_password" placeholder='Confirm New Password' required />
    </div>

    <button className='px-8 w-full py-3 bg-[#2563EB] hover:bg-[#1d4ed8] transition-colors font-semibold text-white rounded-lg'>Reset Password</button>

        </form>
    </div>

    <div className='text-center text-slate-500 text-sm pt-4'>
        <p>Remembered it? <Link className='text-[#2563EB] font-semibold hover:underline' to='/login'> Sign In</Link> </p>
    </div>
