...
const Categorys = () => {
    ...
    return (
        <div className='w-full py-14 bg-[#9BD7D1]'>
        <div className='w-[87%] mx-auto relative'>
            <div className='w-full'>
            <div className='text-center flex justify-center items-center flex-col text-3xl text-slate-900 font-bold relative pb-[40px]'>
                <h2>Top Category</h2>
                ...
                >
                {
                    categorys.map((c, i) => <Link className='group block rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300' key={c._id || i} to={`/products?category=${c.name}`}>
