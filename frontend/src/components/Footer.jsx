...
const Footer = () => {
            ...
            <div className='w-[85%] flex flex-wrap mx-auto border-b border-white/10 py-16 md-lg:pb-10 sm:pb-6 gap-y-10'>
                ...
                <div className='flex justify-between gap-[80px] lg:gap-[40px]'>
                    <ul className='flex flex-col gap-2.5 text-slate-300 text-sm font-medium'>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>About Us </Link>
                        </li>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>About Our Shop </Link>
                        </li>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>Delivery Information </Link>
                        </li>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>Privacy Policy </Link>
                        </li>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>Blogs  </Link>
                        </li>
                    </ul>

                    <ul className='flex flex-col gap-2.5 text-slate-300 text-sm font-medium'>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>Our Service </Link>
                        </li>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>Company Profile</Link>
                        </li>
                        <li>
                            <Link className='hover:text-white hover:pl-1 transition-all duration-200'>Delivery Information </Link>
                        </li>
    ...
    <div className='hidden fixed md-lg:block w-[54px] h-[118px] bottom-4 right-3 bg-white rounded-full p-2 shadow-2xl z-50'>
        ...
        <div title="Cart" onClick={() => navigate(userInfo ? '/card' : '/login') }  className='relative flex justify-center items-center cursor-pointer w-[38px] h-[38px] rounded-full bg-slate-100 hover:bg-[#2563EB] group transition-colors'>
        ...
        <div title="Wishlist" onClick={() => navigate(userInfo ? '/dashboard/my-wishlist' : '/login') } className='relative flex justify-center items-center cursor-pointer w-[38px] h-[38px] rounded-full bg-slate-100 hover:bg-[#2563EB] group transition-colors'>
