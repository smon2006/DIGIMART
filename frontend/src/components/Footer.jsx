...
const Footer = () => {
        ...
        <footer className='bg-[#1e293b] shadow-[0_-8px_20px_-6px_rgba(0,0,0,0.25)] relative z-10'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b border-white/10 py-16 md-lg:pb-10 sm:pb-6 gap-y-10'>
                ...
                <div className='w-5/12 lg:w-8/12 sm:w-full'>
                    <div className='flex justify-center sm:justify-start sm:mt-6 w-full'>
                        <div>
                <h2 className='font-bold text-base mb-5 text-white uppercase tracking-wide relative pb-3 after:absolute after:left-0 after:bottom-0 after:w-8 after:h-[2px] after:bg-[#0891B2]'>Useful Links</h2>
            ...
            <div className='w-4/12 lg:w-full lg:mt-6'>
                <div className='w-full flex flex-col justify-start gap-4'>
                    <h2 className='font-bold text-base mb-1 text-white uppercase tracking-wide relative pb-3 after:absolute after:left-0 after:bottom-0 after:w-8 after:h-[2px] after:bg-[#0891B2]'>Join Our Shop</h2>
                    <span className='text-slate-300 text-sm leading-relaxed'>Get email updates about your latest and shop special offers</span>
                    <div className='h-[48px] w-full bg-white rounded-full relative overflow-hidden ring-1 ring-white/10 focus-within:ring-2 focus-within:ring-[#0891B2] transition-all'>
                        ...
                        <button title="Subscribe" className='h-[38px] absolute right-[5px] top-[5px] rounded-full bg-[#0891B2] hover:bg-[#0E7490] transition-colors text-white uppercase px-5 font-bold text-xs'>Subscribe</button>  
                     </div> 
                     <ul className='flex justify-start items-center gap-3 mt-1'>
                        <li>
                            <a title="LinkedIn" className='w-[38px] h-[38px] hover:bg-[#0891B2] hover:-translate-y-0.5 transition-all duration-200 flex justify-center items-center bg-white text-slate-700 hover:text-white rounded-full shadow-sm' href="https://www.linkedin.com/in/shrestha-mondal-cse/" target="_blank" rel="noopener noreferrer"><FaLinkedin/> </a>
                        </li>
                        <li>
                            <a title="GitHub" className='w-[38px] h-[38px] hover:bg-[#0891B2] hover:-translate-y-0.5 transition-all duration-200 flex justify-center items-center bg-white text-slate-700 hover:text-white rounded-full shadow-sm' href="https://github.com/smon2006/DIGIMART" target="_blank" rel="noopener noreferrer"><FaGithub/> </a>
                        </li>
    ...
    <div className='hidden fixed md-lg:block w-[54px] h-[118px] bottom-4 right-3 bg-white rounded-full p-2 shadow-2xl z-50'>
        ...
        <div title="Cart" onClick={() => navigate(userInfo ? '/card' : '/login') }  className='relative flex justify-center items-center cursor-pointer w-[38px] h-[38px] rounded-full bg-slate-100 hover:bg-[#0891B2] group transition-colors'>
        ...
        <div title="Wishlist" onClick={() => navigate(userInfo ? '/dashboard/my-wishlist' : '/login') } className='relative flex justify-center items-center cursor-pointer w-[38px] h-[38px] rounded-full bg-slate-100 hover:bg-[#0891B2] group transition-colors'>
