...
const FeatureProducts = ({ products }) => {
    ...
    return ( 
        /* Reduced bottom padding from pb-10 to pb-2 to shrink the gap */
        <div className='w-[85%] flex flex-wrap mx-auto -mt-6 pb-2'>
            <div className='w-full'>
                <div className='text-center flex justify-center items-center flex-col text-3xl text-slate-900 font-bold relative pb-8'>
                                ...
                                <div className='flex justify-start items-center gap-3 mt-1'>
                                    {
                                        p.discount > 0 ? (
                                            <span className='text-base font-bold text-slate-800'>
                                                ...
                                                <span className='text-base font-semibold text-red-500 whitespace-nowrap'>({p.discount}% off)</span>
                                            </span>
                                        ) : (
