    ...
    return (
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4 bg-[#334155] rounded-md'>
                <div className='flex justify-between items-center'>
                    <select onChange={(e) => setParPage(parseInt(e.target.value))} className='px-4 py-2 focus:border-blue-600 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]'>
        ...
        <div className='relative mt-5 overflow-x-auto'>
            <div className='w-full text-sm text-left [#E2E8F0]'>
                <div className='text-sm text-[#E2E8F0] uppercase border-b border-slate-700'>
        ...
        {
            myOrders.map((o,i) =>  <div className='text-[#E2E8F0] '>
