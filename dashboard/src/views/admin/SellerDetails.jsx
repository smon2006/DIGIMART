...
const SellerDetails = () => {
    ...
    <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-[#475569] rounded-md'>
        ...
        <div> 
            <form onSubmit={submit} >
                <div className='flex gap-4 py-3'>
                    <select value={status} onChange={(e)=>setStatus(e.target.value)} className='px-4 py-2 focus:border-blue-600 outline-none bg-[#475569] border border-[#64748B] rounded-md text-[#E2E8F0]' name="" id="" required>
